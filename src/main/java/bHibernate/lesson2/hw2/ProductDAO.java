...
public class ProductDAO {
    ...
    final private static String findById = "select * from PRODUCTHB where PRODUCTHB.ID = ?";
    final private static String findByName = "select * from PRODUCTHB where PRODUCTHB.NAME = ?";
    final private static String findByContainedName = "select * from PRODUCTHB where PRODUCTHB.NAME like ?";
    final private static String findByPrice = "select * from PRODUCTHB where PRODUCTHB.PRICE between ? and ?";
    final private static String findByNameSortedAsc = "select * from PRODUCTHB where PRODUCTHB.NAME = ? order by PRODUCTHB.NAME asc";
    final private static String findByNameSortedDesc = "select * from PRODUCTHB where PRODUCTHB.NAME = ? order by PRODUCTHB.NAME desc";
    final private static String findByPriceSortedDesc = "select * from PRODUCTHB where PRODUCTHB.PRICE between ? and ? order by PRODUCTHB.PRICE desc";
