...
public class FileDAO  {
    ...
    public static List<File> findById (long id){
        try (Connection connection = getConnection();
             PreparedStatement prepareStatement = connection.prepareStatement("SELECT * FROM FILE WHERE  ID = ?")) {
             return findByIdQuery(prepareStatement, id);
    ...
    public static List<File> findByIdStorage (long id){
        try (Connection connection = getConnection();
             PreparedStatement prepareStatement = connection.prepareStatement("SELECT * FROM FILE WHERE  STORAGE_ID = ?")) {
             return findByIdQuery(prepareStatement, id);
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    private static List<File> findByIdQuery(PreparedStatement prepareStatement, long id) throws SQLException{
        prepareStatement.setLong (1,id);
